...
namespace ServicesController.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Company_Name,Description,Type,Contact_Email,Address,Phone_no,Certification,serviceID")] Service service)
        {
        ...
        [HttpPost]
        public ActionResult Add(Service s,
            HttpPostedFileBase ImageUpload)
        {
            if (ModelState.IsValid)
            {
                ...
                s.Certification = "~/Images/" + myfilename;
            ...
            {
                ViewBag.Message = "Registration Unsuccessfull....Pls try again";
                return View();
            }
