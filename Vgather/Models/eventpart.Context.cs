...
namespace Vgather.Models
{
    ...
    public partial class EventManagementEntities1 : DbContext
    {
        ...
        public virtual ObjectResult<string> EventTypes1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("EventTypes1");
        }
        ...
        public virtual ObjectResult<string> VenueName(Nullable<int> eventType)
        {
            var eventTypeParameter = eventType.HasValue ?
                new ObjectParameter("EventType", eventType) :
                new ObjectParameter("EventType", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("VenueName", eventTypeParameter);
        }
    }
}
